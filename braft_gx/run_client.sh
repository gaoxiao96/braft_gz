...
DEFINE_integer thread_num 500 'Number of sending thread'
...
DEFINE_integer request_size 1024 "channel request size"
DEFINE_integer send_time 200 "request time"
DEFINE_integer tm 10 "show qps msg"
