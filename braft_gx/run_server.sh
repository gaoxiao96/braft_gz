...
DEFINE_string data_path '/gx_data' 'Path of data stored on'
DEFINE_integer raft_max_append_buffer_size '262144' 'Number of worker pthreads'
...
# echo ${FLAGS_raft_max_append_buffer_size}
...
for ((i=0; i<$FLAGS_server_num; ++i)); do
    ...
    ${VALGRIND} ./block_server \
        ...
        -raft_max_append_buffer_size=${FLAGS_raft_max_append_buffer_size} \
